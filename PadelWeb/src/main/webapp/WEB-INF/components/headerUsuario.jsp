...
<aside class="sidebar">
    ...
    <nav class="menu">
        ...
        <a href="<%= request.getContextPath() %>/canchaUsuario"><i class="fi fi-rr-tennis"></i> Canchas</a>
        <a href="<%= request.getContextPath() %>/reservasUsuario"><i class="fi fi-rr-calendar"></i> Reservas </a>
        <a href="<%= request.getContextPath() %>/grupojugador"><i class="fi fi-rr-users"></i> Grupos</a>
